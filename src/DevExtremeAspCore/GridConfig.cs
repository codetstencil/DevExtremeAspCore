...
namespace ZeraSystems.DevExtremeAspCore
{
    ...
    [CodeStencilCodeNanite(new[]
    {
        ...
        "Generates configuration for the Grid",    
        // 2 - Details: This is the description of the Code Nanite/Plugin
        "This code nanite will generate a configuration for the Grid",
        // 3 - Version Number
        "1.0",                                 
    ...
    public partial class GridConfig : ExpansionBase, ICodeStencilCodeNanite
    { 
